...
public class ExpendituresControllerRestTemplateIT {
    ...
    void testGetExpenditures() {
        template.postForObject(DEFAULT_URL,
                new CreateSpendingCommand(LocalDate.of(2000, 01, 01), "Apple laptop", 200_000), SpendingDto.class);

        template.postForObject(DEFAULT_URL,
                new CreateSpendingCommand(LocalDate.of(2020, 06, 30), "haircut", 1800), SpendingDto.class);
    ...
    void testGetSpendingById() {
        ...
        assertThat(testSpending)
                .extracting(SpendingDto::getDate)
    ...
    void testCreateSpendingWithMinusCost() {
        Problem result = template.postForObject(DEFAULT_URL,
                new CreateSpendingCommand(LocalDate.of(2020, 06, 30), "haircut", -200), Problem.class);
    ...
    void testCreateSpendingWithEmptyName() {
        Problem result = template.postForObject(DEFAULT_URL,
                new CreateSpendingCommand(LocalDate.of(2020, 06, 30), "   ", 200), Problem.class);
